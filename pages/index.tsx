    ...
    <div id="myCarousel" className="carousel slide" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="/assets/images/Rectangle2.png" className="bd-placeholder-img" width="100%" height="100%" alt="" />
              <div className="row">
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-3 text-center">
                <div className="statistick">
                  <div className="statistick_icon">
                    <img src="/assets/images/Group74.png" alt="" />
                  </div>
              ...
              <div className="col-md-3 text-center">
                <div className="statistick">
                  <div className="statistick_icon">
                    <img src="/assets/images/Group64.png" alt="" />
                  </div>
                  <div className="statistick_content">
                    <h3>1000+</h3>
              ...
              <div className="col-md-3 text-center">
                <div className="statistick">
                  <div className="statistick_icon">
                    <img src="/assets/images/Group63.png" alt="" />
                  </div>
                  <div className="statistick_content">
                    <h3>1000+</h3>
              ...
              <div className="col-md-3 text-center">
                <div className="statistick">
                  <div className="statistick_icon">
                    <img src="/assets/images/Group62.png" alt="" />
                  </div>
                  <div className="statistick_content">
                    <h3>1000+</h3>
          ...
          <div className="container">
            ...
            <div className="row py-4">
              ...
              <div className="col-md-5 col-sm-6 text-center">
                <div className="card">
                  <div className="text-center">
                    <img src="/assets/images/abroad1.png" className="card-img-top" alt="..." />
                  </div>
              ...
              <div className="col-md-5 col-sm-6 text-center">
                <div className="card ">
                  <div className="text-center">
                    <img src="/assets/images/cow1.png" className="card-img-top" alt="..." />
                  </div>
                  <div className="card-body">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="why_online_img">
                  <img src="/assets/images/Rectangle75.png" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="ins_step">
          <div className="container">
            ...
            <div class="col-md-4"> <span class="step3 step_circle_count">03</span></div> */}
                    <div className="col-md-4"> <img src="/assets/images/step1.png" alt="" className="step_img" /> </div>
                    <div className="col-md-4"> <img src="/assets/images/step2.png" alt="" className="step_img" /> </div>
                    <div className="col-md-4"> <img src="/assets/images/step3.png" alt="" className="step_img" /> </div>
                  </div>
                </div>
              </div>
              <div className="row easy_step">
                  ...
                  <div className="row text-">
                    <div className="col-md-6">
                      <div className="card review_card text-left">
                        <div className="text-">
                          <img src="/assets/images/user.jpg" className="card-img-review" alt="..." />
                          <div className="my-2">
